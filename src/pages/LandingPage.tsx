          ...
          <AnimateInView className="w-full max-w-sm">
            <div className="brand-card">
              <div className="flex justify-center mb-4">
                <img src="https://www.sonatech.ac.in/images/logo.png" alt="Sona College" className="h-12 w-12 object-contain" />
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@sonatech.ac.in"
                ...
                <button onClick={mode === "login" ? handleEmailLogin : handleEmailSignup} className="pill-btn w-full gap-2"
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <button onClick={() => { setMode("choice"); setEmail(""); setPassword(""); }}
                    className="text-muted-foreground hover:text-foreground transition-colors">← Back</button>
                </div>
              </div>
            </div>
          </AnimateInView>
